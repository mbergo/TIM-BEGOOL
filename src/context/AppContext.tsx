...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    s4_calc3: "Sync records across 12 distributed brokers to maintain strict 3-way fault tolerance.",
    ...
    s6_impact: "Directly avoids 21.4% unnecessary truck rolls, dramatically optimizing operations and customer satisfaction.",
  ...
  pt: {
    ...
    s4_calc3: "Sincroniza registros em 12 brokers distribuídos para manter tolerância a falhas estrita de 3 vias.",
    ...
    s6_impact: "Evita diretamente 21,4% de envios desnecessários de técnicos, otimizando drasticamente as operações e o NPS.",
  ...
  it: {
    ...
    s4_calc3: "Sincronizza i record su 12 broker distribuiti per mantenere una tolleranza ai guasti a 3 vie.",
    ...
    s6_impact: "Evita direttamente il 21.4% delle uscite non necessarie dei tecnici, ottimizzando le operazioni e l'esperienza cliente.",
